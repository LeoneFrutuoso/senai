...
for (let i = 0; i < produtos.length; i++) {
    ...
    document.getElementById('lista-precos').innerHTML += '<p>' + produtos[i] + '</p>';  
}
     ...
     //prompt para riar array de nome de produtos array js, um unico
     //  e simples array de string com 50 posiçoes e um nome de produto em cada posiçao
...
// document.getElementById('precos').innerHTML +=  + precos[i] + '-'
// }
